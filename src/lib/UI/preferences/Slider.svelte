...
<div class='flex w-full items-center'>
	<input name={name} type='range' class="w-full my-2 mb-3 h-2 shadow bg-primary rounded-lg appearance-none cursor-pointer dark:bg-secondary" bind:value min={range[0]} max={range[1]} on:input={() => doSnap()}>
